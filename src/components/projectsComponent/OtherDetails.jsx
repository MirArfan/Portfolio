...
const OtherDetails = (props) => {
  return (
    <div className={'w-[80%] '}>
      ...
      <p className='text-sm font-normal'> A responsive replica of Amazon's homepage using HTML and CSS.<br /> Mimics the layout and design  elements of the original, including the <br />header with search bar and navigation, featured products, and footer links. </p>
